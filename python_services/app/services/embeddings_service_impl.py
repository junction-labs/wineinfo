...
from ..common.api import EmbeddingsSearchRequest, Wine


class EmbeddingsServiceImpl:
    def __init__(
        self, settings: ServiceSettings, reset: bool = False):
        self.embeddings_demo_failure = settings.embeddings_demo_failure
        path = os.path.join(settings.data_path, "embeddings_data")
